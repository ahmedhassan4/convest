...
const config: Config = {
  content: [
    './src/app/**/*.{js,ts,jsx,tsx}', // Include all your app directory files
    './src/components/**/*.{js,ts,jsx,tsx}', // Include your components directory
    './src/shared/**/*.{js,ts,jsx,tsx}', // Include any shared components
    './src/layouts/**/*.{js,ts,jsx,tsx}',// Include layout files if applicable
    './src/**/*.{js,ts,jsx,tsx}',
